...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(26, 26, "include", "/include/data_single_season.stan");
    reader.add_event(26, 0, "start", "/include/data_single_season.stan");
    reader.add_event(50, 24, "end", "/include/data_single_season.stan");
    reader.add_event(50, 27, "restart", "model_pcount");
    reader.add_event(58, 35, "include", "/include/params_single_season.stan");
    reader.add_event(58, 0, "start", "/include/params_single_season.stan");
    reader.add_event(65, 7, "end", "/include/params_single_season.stan");
    reader.add_event(65, 36, "restart", "model_pcount");
    reader.add_event(96, 67, "include", "/include/model_single_season.stan");
    reader.add_event(96, 0, "start", "/include/model_single_season.stan");
    reader.add_event(119, 23, "end", "/include/model_single_season.stan");
    reader.add_event(119, 68, "restart", "model_pcount");
    reader.add_event(123, 70, "end", "model_pcount");
    return reader;
}
