...
namespace model_pcount_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(36, 36, "include", "/include/data.stan");
    reader.add_event(36, 0, "start", "/include/data.stan");
    reader.add_event(69, 33, "end", "/include/data.stan");
    reader.add_event(69, 37, "restart", "model_pcount");
    reader.add_event(74, 42, "include", "/include/params_single_season.stan");
    reader.add_event(74, 0, "start", "/include/params_single_season.stan");
    reader.add_event(81, 7, "end", "/include/params_single_season.stan");
    reader.add_event(81, 43, "restart", "model_pcount");
    reader.add_event(112, 74, "include", "/include/rand_priors_single_season.stan");
    reader.add_event(112, 0, "start", "/include/rand_priors_single_season.stan");
    reader.add_event(127, 15, "end", "/include/rand_priors_single_season.stan");
    reader.add_event(127, 75, "restart", "model_pcount");
    reader.add_event(127, 75, "include", "/include/fixed_priors_single_season.stan");
    reader.add_event(127, 0, "start", "/include/fixed_priors_single_season.stan");
    reader.add_event(129, 2, "end", "/include/fixed_priors_single_season.stan");
    reader.add_event(129, 76, "restart", "model_pcount");
    reader.add_event(135, 80, "end", "model_pcount");
    return reader;
}
template <typename T1__, typename T2__>
typename boost::math::tools::promote_args<T1__, T2__>::type
lp_pcount_pois(const std::vector<int>& y,
    ...
    try {
        ...
        local_scalar_t__ fac(DUMMY_VAR__);
        (void) fac;  // dummy to suppress unused var warning
        stan::math::initialize(fac, DUMMY_VAR__);
        stan::math::fill(fac, DUMMY_VAR__);
        stan::math::assign(fac,1);
        current_statement_begin__ = 6;
        local_scalar_t__ ff(DUMMY_VAR__);
        (void) ff;  // dummy to suppress unused var warning
        stan::math::initialize(ff, DUMMY_VAR__);
        stan::math::fill(ff, DUMMY_VAR__);
        stan::math::assign(ff,(stan::math::exp(log_lambda) * prod(subtract(1, inv_logit(logit_p)))));
        ...
        local_scalar_t__ ky(DUMMY_VAR__);
        ...
        stan::math::assign(numN,(K - Kmin));
        current_statement_begin__ = 10;
        for (int i = 1; i <= numN; ++i) {
            current_statement_begin__ = 11;
            stan::math::assign(N, ((K - i) + 1));
            current_statement_begin__ = 12;
            stan::math::assign(ky, 1);
            current_statement_begin__ = 13;
            for (int j = 1; j <= size(y); ++j) {
                current_statement_begin__ = 14;
                stan::math::assign(ky, (ky * (N / (N - get_base1(y, j, "y", 1)))));
            }
            current_statement_begin__ = 16;
            stan::math::assign(fac, (1 + (((fac * ff) * ky) / N)));
        }
        current_statement_begin__ = 18;
        return stan::math::promote_scalar<fun_return_scalar_t__>(((poisson_log_log(Kmin, log_lambda) + binomial_logit_log(y, Kmin, logit_p)) + stan::math::log(fac)));
        }
...
struct lp_pcount_pois_functor__ {
    template <typename T1__, typename T2__>
        typename boost::math::tools::promote_args<T1__, T2__>::type
    operator()(const std::vector<int>& y,
        ...
        return lp_pcount_pois(y, log_lambda, logit_p, K, Kmin, pstream__);
    }
};
template <typename T4__, typename T5__, typename T7__>
Eigen::Matrix<typename boost::math::tools::promote_args<T4__, T5__, T7__>::type, Eigen::Dynamic, 1>
get_loglik_pcount(const std::vector<int>& y,
                      ...
                      const int& z_dist,
                      const T7__& beta_zdist,
                      const int& K,
                      const std::vector<std::vector<int> >& Kmin, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T4__, T5__, T7__>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
        local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
...
struct get_loglik_pcount_functor__ {
    template <typename T4__, typename T5__, typename T7__>
        Eigen::Matrix<typename boost::math::tools::promote_args<T4__, T5__, T7__>::type, Eigen::Dynamic, 1>
    operator()(const std::vector<int>& y,
                      const int& M,
        ...
        return get_loglik_pcount(y, M, J, si, log_lambda, logit_p, z_dist, beta_zdist, K, Kmin, pstream__);
    }
};
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_pcount_namespace::model_pcount";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(log_lik, get_loglik_pcount(y, M, J, si, log_lambda, logit_p, z_dist, beta_zdist, K, Kmin, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_pcount_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_pcount_namespace::model_pcount stan_model;
#endif
