...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(39, 39, "include", "/include/data.stan");
    reader.add_event(39, 0, "start", "/include/data.stan");
    reader.add_event(72, 33, "end", "/include/data.stan");
    reader.add_event(72, 40, "restart", "model_pcount");
    reader.add_event(77, 45, "include", "/include/params_single_season.stan");
    reader.add_event(77, 0, "start", "/include/params_single_season.stan");
    reader.add_event(84, 7, "end", "/include/params_single_season.stan");
    reader.add_event(84, 46, "restart", "model_pcount");
    reader.add_event(115, 77, "include", "/include/model_single_season.stan");
    reader.add_event(115, 0, "start", "/include/model_single_season.stan");
    reader.add_event(140, 25, "end", "/include/model_single_season.stan");
    reader.add_event(140, 78, "restart", "model_pcount");
    reader.add_event(144, 80, "end", "model_pcount");
    return reader;
}
