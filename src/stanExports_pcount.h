...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(49, 49, "include", "/include/data_single_season.stan");
    reader.add_event(49, 0, "start", "/include/data_single_season.stan");
    reader.add_event(73, 24, "end", "/include/data_single_season.stan");
    reader.add_event(73, 50, "restart", "model_pcount");
    reader.add_event(81, 58, "include", "/include/params_single_season.stan");
    reader.add_event(81, 0, "start", "/include/params_single_season.stan");
    reader.add_event(88, 7, "end", "/include/params_single_season.stan");
    reader.add_event(88, 59, "restart", "model_pcount");
    reader.add_event(119, 90, "include", "/include/model_single_season.stan");
    reader.add_event(119, 0, "start", "/include/model_single_season.stan");
    reader.add_event(142, 23, "end", "/include/model_single_season.stan");
    reader.add_event(142, 91, "restart", "model_pcount");
    reader.add_event(146, 93, "end", "model_pcount");
    return reader;
}
...
lp_pcount_pois(const std::vector<int>& y,
    ...
    try {
        ...
        for (int i = Kmin; i <= K; ++i) {
            ...
            stan::math::assign(out, (out + (poisson_log_log(i, log_lambda) + binomial_logit_log(y, i, logit_p))));
        }
...
template <typename T1__, typename T2__>
typename boost::math::tools::promote_args<T1__, T2__>::type
lp_pcount_rec(const std::vector<int>& y,
                  const T1__& log_lambda,
                  const Eigen::Matrix<T2__, Eigen::Dynamic, 1>& logit_p,
                  const int& K,
                  const int& Kmin, std::ostream* pstream__) {
    ...
    try {
        ...
        local_scalar_t__ rk(DUMMY_VAR__);
        (void) rk;  // dummy to suppress unused var warning
        stan::math::initialize(rk, DUMMY_VAR__);
        stan::math::fill(rk, DUMMY_VAR__);
        current_statement_begin__ = 17;
        validate_non_negative_index("ry", "size(y)", size(y));
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> ry(size(y));
        stan::math::initialize(ry, DUMMY_VAR__);
        stan::math::fill(ry, DUMMY_VAR__);
        stan::math::assign(ry,to_vector(y));
        ...
        for (int k = K; k <= Kmin; ++k) {
            current_statement_begin__ = 21;
            stan::math::assign(rk, k);
            current_statement_begin__ = 22;
            stan::math::assign(ky, 1);
            current_statement_begin__ = 23;
            for (int i = 1; i <= size(y); ++i) {
                current_statement_begin__ = 24;
                stan::math::assign(ky, (ky * (rk / (rk - get_base1(ry, i, "ry", 1)))));
            }
            current_statement_begin__ = 26;
            stan::math::assign(fac, (1 + (((fac * ff) * ky) / rk)));
        }
...
struct lp_pcount_rec_functor__ {
    template <typename T1__, typename T2__>
        typename boost::math::tools::promote_args<T1__, T2__>::type
    operator()(const std::vector<int>& y,
                  const T1__& log_lambda,
                  ...
                  const int& K,
                  const int& Kmin, std::ostream* pstream__) const {
        return lp_pcount_rec(y, log_lambda, logit_p, K, Kmin, pstream__);
    }
};
template <typename T3__, typename T4__, typename T6__>
Eigen::Matrix<typename boost::math::tools::promote_args<T3__, T4__, T6__>::type, Eigen::Dynamic, 1>
get_loglik_pcount(const std::vector<std::vector<int> >& y,
                      const int& M,
                      const int& J,
    ...
    try {
        ...
        for (int i = 1; i <= M; ++i) {
            ...
            stan::model::assign(out, 
                        ...
                        lp_pcount_rec(get_base1(y, i, "y", 1), get_base1(log_lambda, i, "log_lambda", 1), stan::model::rvalue(logit_p, stan::model::cons_list(stan::model::index_min_max(idx, ((idx + J) - 1)), stan::model::nil_index_list()), "logit_p"), K, get_base1(Kmin, i, "Kmin", 1), pstream__), 
