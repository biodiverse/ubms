...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(27, 27, "include", "/include/data_single_season.stan");
    reader.add_event(27, 0, "start", "/include/data_single_season.stan");
    reader.add_event(51, 24, "end", "/include/data_single_season.stan");
    reader.add_event(51, 28, "restart", "model_occu");
    reader.add_event(57, 34, "include", "/include/params_single_season.stan");
    reader.add_event(57, 0, "start", "/include/params_single_season.stan");
    reader.add_event(64, 7, "end", "/include/params_single_season.stan");
    reader.add_event(64, 35, "restart", "model_occu");
    reader.add_event(93, 64, "include", "/include/model_single_season.stan");
    reader.add_event(93, 0, "start", "/include/model_single_season.stan");
    reader.add_event(116, 23, "end", "/include/model_single_season.stan");
    reader.add_event(116, 65, "restart", "model_occu");
    reader.add_event(120, 67, "end", "model_occu");
    return reader;
}
...
get_loglik_occu(const std::vector<std::vector<int> >& y,
                    const int& M,
                    const int& J,
