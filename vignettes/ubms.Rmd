...
Another alternative to `ubms` would be to fit models in an existing modeling language such as BUGS, [JAGS](http://mcmc-jags.sourceforge.net/), or directly in Stan.
