...
One of the advantages of `ubms` is that it is possible to include random effects in your models, using the same syntax as [lme4](https://cran.r-project.org/web/packages/lme4/index.html) [@Bates_2015].
...
The logical model choice for such data is a multi-season model, such as the dynamic occupancy model [CITE] or some form of Dail-Madsen model for count data [CITE].
...
## (Intercept)       -1.62 0.237 -2.138 -1.18 112.5 1.010
## scale(ele)         1.17 0.237  0.746  1.65 189.1 0.998
## scale(forest)      1.53 0.270  1.080  2.13  52.2 1.007
## sigma [1|site]     1.97 0.378  1.371  2.81  33.5 1.010
## 
## Detection (logit-scale):
##             Estimate     SD   2.5% 97.5% n_eff Rhat
## (Intercept)    0.177 0.1049 -0.023 0.394   501    1
## scale(date)    0.337 0.0935  0.154 0.516  1328    1
## 
## LOOIC: 1473.155
```
...
```
##          1          2          3          4          5          6 
## -1.9149623 -2.0127713 -0.2941755  0.1155416  0.3387905 -1.8547888
```
...
## 1 -1.9149623 2.040042 -6.250911 1.7524062
## 2 -2.0127713 1.675006 -5.555441 0.9047885
## 3 -0.2941755 1.423299 -3.224786 2.6999613
## 4  0.1155416 1.324165 -2.459340 2.5714592
## 5  0.3387905 1.282113 -1.969159 3.2183435
## 6 -1.8547888 1.860384 -5.609624 1.5336648
```
