...
## 
## Call:
## stan_occu(formula = form, data = umf, chains = 3, cores = 3)
## 
## Occupancy (logit-scale):
##             Estimate     SD    2.5%  97.5% n_eff Rhat
## (Intercept)   -1.084 0.2443 -1.5666 -0.612   933 1.00
## habCov12      -0.204 0.3263 -0.8585  0.418  2067 1.00
## habCov13      -0.245 0.3380 -0.9373  0.399  1945 1.00
## habCov2        1.112 0.1744  0.7914  1.464  1114 1.00
## RSR [tau]      0.141 0.0538  0.0618  0.269   206 1.01
## 
## Detection (logit-scale):
##             Estimate    SD   2.5% 97.5% n_eff Rhat
## (Intercept)    1.748 0.380  1.056 2.546  1594    1
## detCov1        0.114 0.214 -0.299 0.535  4464    1
## detCov21       1.230 0.577  0.120 2.404  2010    1
## detCov22       1.431 0.585  0.292 2.606  2023    1
## detCov23      -0.258 0.506 -1.257 0.710  1869    1
## 
## LOOIC: 670.079
```
...
## 1 0.1375419 0.04510106 0.06673749 0.2450371
## 2 0.2301707 0.08477789 0.10070910 0.4315150
## 3 0.3551394 0.11607816 0.16659691 0.6103193
## 4 0.4522749 0.12664576 0.22468614 0.7208363
## 5 0.4522390 0.12280803 0.23486858 0.7114437
## 6 0.3809225 0.11546636 0.17960428 0.6248035
```
...
## fit_ubms       -335.04  47.54      0.00    0.00      1
## fit_nonspatial -381.27   9.19    -46.23    8.38      0
```
