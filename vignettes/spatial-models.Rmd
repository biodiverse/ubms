...
## 
## Call:
## stan_occu(formula = form, data = umf, chains = 3)
## 
## Occupancy (logit-scale):
##             Estimate     SD    2.5%  97.5% n_eff Rhat
## (Intercept)   -1.077 0.2389 -1.5736 -0.621  1479 1.00
## habCov12      -0.206 0.3303 -0.8384  0.441  2139 1.00
## habCov13      -0.256 0.3435 -0.9220  0.417  1863 1.00
## habCov2        1.114 0.1768  0.7869  1.481  1343 1.00
## RSR [tau]      0.141 0.0552  0.0642  0.274   225 1.01
## 
## Detection (logit-scale):
##             Estimate    SD   2.5% 97.5% n_eff  Rhat
## (Intercept)    1.695 0.392  0.947 2.507  1359 1.002
## detCov1        0.114 0.214 -0.291 0.536  4242 0.999
## detCov21       1.326 0.622  0.152 2.660  2153 1.000
## detCov22       1.534 0.602  0.397 2.826  1871 1.000
## detCov23      -0.215 0.522 -1.206 0.816  1844 1.000
## 
## LOOIC: 669.228
```
...
## 1 0.1377537 0.04573613 0.06612909 0.2447425
## 2 0.2302972 0.08700916 0.09788428 0.4333969
## 3 0.3543871 0.11976392 0.15709094 0.6244015
## 4 0.4507624 0.13170205 0.22163401 0.7223539
## 5 0.4506006 0.12536403 0.22482546 0.7152775
## 6 0.3796596 0.11863216 0.17572626 0.6416240
```
...
## fit_ubms       -334.61  47.09      0.00    0.00      1
## fit_nonspatial -381.08   9.04    -46.47    8.35      0
```
