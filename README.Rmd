...
Right now there are Stan versions of unmarked functions `occu`, `occuRN`, `colext`, `pcount`, and `distsamp` (`stan_occu`, `stan_occuRN`, `stan_colext`, `stan_pcount`, `stan_distsamp`).
